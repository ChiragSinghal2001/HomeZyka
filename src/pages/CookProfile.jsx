        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="bg-white p-1 rounded-full inline-flex mb-8 shadow-sm">
              {['Meals', 'Reviews', 'Favorites'].map(tab => (
                <button
                  key={tab}
            ...
            <div className="min-h-[400px]">
              ...
              {activeTab === 'Favorites' && (
                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border border-dashed border-dark/20">
                  <i className="far fa-heart text-4xl text-gray-text/30 mb-4"></i>
                  <h3 className="font-display text-2xl mb-2">No favorites yet</h3>
                  <p className="text-gray-text mb-8 text-center px-4">Browse meals and save your favorites</p>
                  <Link to="/browse" className="bg-mustard px-8 py-3 rounded-full font-bold">Browse Meals</Link>
                </div>
              )}
            </div>
          </div>
